...
# PARAM$semillas <- c(703733, 755903, 763339, 861491, 919691)
PARAM$semillas <- c(958777,655181,888779,391961,726109,352607,289657,318319,523867,793343,437033,261043,720311,664633,117911,176041,589453,725423,916501,435451)
