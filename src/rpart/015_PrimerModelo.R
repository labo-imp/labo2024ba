...
# cp=-.65 minsplit=950 minbucket =500 maxdepth =5
modelo <- rpart(
    formula = "clase_ternaria ~ .",
    data = dtrain, # los datos donde voy a entrenar
    xval = 0,
    cp = -0.65, # esto significa no limitar la complejidad de los splits
    minsplit = 950, # minima cantidad de registros para que se haga el split
...
fwrite(dapply[, list(numero_de_cliente, Predicted)],
        file = "./exp/KA2001/K101_015_viv.csv",
        sep = ","
)
