...
# cp=-0.5 minsplit=5 minbucket =1 maxdepth =3
modelo <- rpart(
...
fwrite(dapply[, list(numero_de_cliente, Predicted)],
        file = "./exp/KA2001/K101_005_viv.csv",
        sep = ","
)

# Subir a Kaggle con:
# kaggle competitions submit -c labo-i-vivencial-2024-ba -f K101_005_viv.csv -m "cp=-0.5 minsplit=5 minbucket =1 maxdepth =3"